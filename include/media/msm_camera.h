...
#define CFG_SET_MANUAL_FOCUS_LENGTH   59     //                                  
#define CFG_SET_LED_FLASH_MODE        60     //                                               
#define CFG_SET_ANTIBANDING_CE1702    61     //                                        
#define CFG_SET_STOP_AF               62     //                                
#define CFG_SET_AF_WINDOW             63     //                                      
#define CFG_SET_AE_WINDOW             64     //                                      
#define CFG_SET_OBJECT_TRACKING       65     //                                                                             
#define CFG_SET_AEC_AWB_LOCK_CE1702   66     //                                             
#define CFG_SET_DIM_INFO              67     //                                                                    
#define CFG_GET_CAM_OPEN_MODE         68     //                                                 
#define CFG_SET_MANUAL_SCENE_MODE     69     //                                                   
#define CFG_SET_GYRO_DATA             70     //                                              
#define CFG_SET_WDR                   71     //                                       
#define CFG_SET_EXIF_ROTATION         72     //                                                         
#define CFG_SET_EXIF_GPS              73     //                                                 
#define CFG_SET_ASD                   74     //                                        
...
/*                                                                  */
	...
	MSM_SENSOR_RES_10,
	MSM_SENSOR_RES_ZSL,//               
	MSM_SENSOR_RES_BURST,//                     
	MSM_SENSOR_RES_HDR,//               
	MSM_SENSOR_RES_LLS,//                          
	MSM_SENSOR_RES_YUV_PREVIEW, //                          
/*                                                                  */

...
static struct isa1200_reg_cmd isa1200_init_seq[] = {
	...
	{LGE_ISA1200_HCTRL2, 0x00},		/*                       */

	{LGE_ISA1200_SCTRL , 0x0F}, 		/*        */

	{LGE_ISA1200_HCTRL0, 0x10},		/*                              
                              */
	{LGE_ISA1200_HCTRL1, 0xC0},		/*                                                */
	{LGE_ISA1200_HCTRL3, 0x33},		/*                                             */

	{LGE_ISA1200_HCTRL4, 0x81},		/*    */
	{LGE_ISA1200_HCTRL5, 0x99},		/*                                      */ /*                             */
	{LGE_ISA1200_HCTRL6, 0x9C},		/*                           */ /*                             */
...
struct i2c_board_info i2c_mhl_info[] = {
	{
		I2C_BOARD_INFO(MHL_I2C_DEVICE_TYPE, 0x72 >> 1),  /*      */
		.irq = MSM_GPIO_TO_INT(GPIO_MHL_INT_N),
		.platform_data = &sii8334_mhl_pdata,
	},
	{
		I2C_BOARD_INFO(MHL_I2C_DEVICE_TYPE, 0x7A >> 1),  /*      */
	},
	{
		I2C_BOARD_INFO(MHL_I2C_DEVICE_TYPE, 0x92 >> 1), /*      */
	},
	{
		I2C_BOARD_INFO(MHL_I2C_DEVICE_TYPE, 0x9A >> 1), /*      */
	},
	{
		I2C_BOARD_INFO(MHL_I2C_DEVICE_TYPE, 0xC8 >> 1), /*       */
	},
};

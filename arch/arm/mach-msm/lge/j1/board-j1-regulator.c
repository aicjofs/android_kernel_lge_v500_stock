...
//                                                                                   
#if defined(CONFIG_MACH_LGE) && (defined(CONFIG_IMX111) || (defined(CONFIG_IMX091)  && (defined(CONFIG_MACH_APQ8064_J1D) || defined(CONFIG_MACH_APQ8064_J1KD))))//                           
//                                                                                 
...
#if 1//                                                                                                                                           
	//                                                                                                                                                
	RPM_LDO(L29, 0, 1, 1, 2700000, 2700000, NULL,          0,     0), //        
#else
	RPM_LDO(L29, 0, 1, 1, 2000000, 2000000, NULL,          0,     0), //        
#endif
/*                                  */ 
	/*                                             */

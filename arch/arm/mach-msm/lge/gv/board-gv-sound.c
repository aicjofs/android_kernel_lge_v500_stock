...
static struct max1462x_platform_data lge_hs_pdata_rev_b = {
	...
	.gpio_mode	= MAX1462X_GPIO_EAR_MIC_EN,		                //                                
	.gpio_det	= MAX1462X_GPIO_EAR_SENSE_N_REVB,		        //                                 
	.gpio_swd	= MAX1462X_GPIO_EAR_KEY_INT_REVB,		        //                                 
	.external_ldo_mic_bias	= MAX1462X_GPIO_MIC_BIAS_CONTROL,	//                                   
	.set_headset_mic_bias = NULL,
	//                                                                                                         
	//                                                                                                             
	.latency_for_detection = 75,
...
static struct max1462x_platform_data lge_hs_pdata_rev_c = {
	...
	.gpio_mode	= MAX1462X_GPIO_EAR_MIC_EN,		                //                                
	.gpio_det	= MAX1462X_GPIO_EAR_SENSE_N_REVC,		        //                                 
	.gpio_swd	= MAX1462X_GPIO_EAR_KEY_INT_REVC,		        //                                 
	.external_ldo_mic_bias	= MAX1462X_GPIO_MIC_BIAS_CONTROL,	//                                   
	.set_headset_mic_bias = NULL,
	//                                                                                                         
	//                                                                                                             

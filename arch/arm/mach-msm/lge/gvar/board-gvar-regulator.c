...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_isp_ram",	"4-0078"), /*                                 */
/*                                                                                     */
};
VREG_CONSUMERS(L9) = {
...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_vana",		"4-0078"), /*                                 */
/*                                                                                     */
};
VREG_CONSUMERS(L12) = {
#if defined(CONFIG_MACH_LGE)
/*                                                                                     */
	REGULATOR_SUPPLY("cam2_vdig",		"4-006c"), /*                                 */
/*                                                                                     */
#else
...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_isp_sys",	"4-0078"), /*                                 */
/*                                                                              */
};
VREG_CONSUMERS(L18) = {
...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_vaf",	"4-0078"), /*                                 */
/*                                                                              */
};
VREG_CONSUMERS(L22) = {
...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_isp_camif",	"4-0078"), /*                                 */
/*                                                                              */
...
/*                                                                                     */
	REGULATOR_SUPPLY("cam1_isp_host",	"4-0078"), /*                                 */
	REGULATOR_SUPPLY("cam2_vio",	"4-006c"), /*                                 */
/*                                                                                     */
};
VREG_CONSUMERS(S2) = {
...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_isp_core",	"4-0078"), /*                                 */
/*                                                                              */
};
VREG_CONSUMERS(LVS1) = {
...
#if defined(CONFIG_MACH_LGE)
/*                                                                              */
	REGULATOR_SUPPLY("cam1_vio",	"4-0078"), /*                                 */
/*                                                                              */
#else
...
/*                                                                              */
	REGULATOR_SUPPLY("cam1_vdig",		"4-0078"), /*                                 */
/*                                                                              */
};
#ifdef CONFIG_HDMI_MVS

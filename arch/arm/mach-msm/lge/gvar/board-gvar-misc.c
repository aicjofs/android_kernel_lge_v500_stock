...
#ifdef CONFIG_LGE_IRRC
#define GPIO_RC_EN    PM8921_GPIO_PM_TO_SYS(23)
...
static void __init irrc_init(void)
{
	...
	if(rc)
		pr_info("%s: pm8xxx_gpio_config %d failed\n",__func__, irrc_data.en_gpio);
...
#ifdef CONFIG_LGE_FTT_CHARGER
#define GPIO_FTT_CHIP_ENABLE		PM8921_GPIO_PM_TO_SYS(26) //               
#define GPIO_FTT_DETECT			PM8921_GPIO_PM_TO_SYS(25) //                   
#define GPIO_FTT_FREQUANCY		22 //                          

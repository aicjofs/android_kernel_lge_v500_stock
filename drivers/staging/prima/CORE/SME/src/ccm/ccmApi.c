...
typedef struct hdd_netdev_priv_s
{
    ...
    tANI_U32 mgmt_ctl_frames;           /*                                     */

    tANI_U32 nir;                       /*                                  
                                                        */
    tANI_U32 stats_dummy_pkt_requeue_cnt;
    tANI_U32 stats_rx_td_dummy_pkt_cnt;/*                                            */
    tANI_U32 stats_rx_tm_dummy_pkt_cnt;/*                                            */
    tANI_U32 stats_td_dummy_pkt_cnt;    /*                                 
                                                                      
                                                                    
                                         */

    tANI_U32 stats_mac_dummy_pkt_drop_cnt;/*                                        
    ...
    tANI_U32 stats_tx_xmit_refilled;         /*                  */
    ...
    struct proc_dir_entry *proc_driver_dir; //                      
#endif
    struct proc_dir_entry *proc_ent_dir;    //                         

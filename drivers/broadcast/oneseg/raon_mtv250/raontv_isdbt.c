...
static void isdbt_InitDemod(void)
{
    ...
    RTV_REG_SET(0x47, 0x13|RTV_COMM_CON47_CLK_SEL); //                    
...
void rtvISDBT_EnableDiversity(void)
{
	...
	RTV_REG_MAP_SEL(OFDM_PAGE); 
       ...
       RTV_REG_SET(0xDD, 0x28);    //         
       RTV_REG_SET(0x07, 0xF9);    //                    
       RTV_REG_SET(0x59, 0x50);    //                                 

       RTV_REG_SET(0x5A,(val_gap << 4) & 0xFF);   //                        
       RTV_REG_SET(0x5B,(val_gap >> 4) & 0xFF);   //        
...
U32 rtvISDBT_GetCNR(void)
{
	...
	if(Constellation_val == 1){
		...
		else if(cn_val > 289000) {	//   
		  cn_a = 0;
		  cn_b = (305000 - cn_val)/166;
		}
		else if(cn_val > 273000) {	//   
		  cn_a = 1;
		  cn_b = (289000 - cn_val)/166;
		}
		else if(cn_val > 254000) {	//   
		  cn_a = 2;
		  cn_b = (273000 - cn_val)/200;
		}
		else if(cn_val > 230500) {	//   
		  cn_a = 3;
		  cn_b = (254000 - cn_val)/233;
		}
		else if(cn_val > 205000) {	//   
		  cn_a = 4;
		  cn_b = (230500 - cn_val)/255;
		}
		else if(cn_val > 178000) {	//   
		  cn_a = 5;
		  cn_b = (205000 - cn_val)/277;
		}
		else if(cn_val > 152000) {	//   
		  cn_a = 6;
		  cn_b = (178000 - cn_val)/266;
		}
		else if(cn_val > 128000) {	//   
		  cn_a = 7;
		  cn_b = (152000 - cn_val)/250;
		}
		else if(cn_val > 104000) {	//   
		  cn_a = 8;
		...
		else if(cn_val > 353500) {	//   
		  cn_a = 0;
		  cn_b = (365000 - cn_val)/124;
		}
		else if(cn_val > 344200) {	//   
		  cn_a = 1;
		  cn_b = (353500 - cn_val)/101;
		}
		else if(cn_val > 333200) {	//   
		  cn_a = 2;
		  cn_b = (344200 - cn_val)/120;
		}
		else if(cn_val > 325000) {	//   
		  cn_a = 3;
		  cn_b = (333200 - cn_val)/90;
		}
		else if(cn_val > 316700) {	//   
		  cn_a = 4;
		  cn_b = (325000 - cn_val)/91;
		}
		else if(cn_val > 308200) {	//   
		  cn_a = 5;
		  cn_b = (316700 - cn_val)/93;
		}
		else if(cn_val > 299000) {	//   
		  cn_a = 6;
		  cn_b = (308200 - cn_val)/98;
		}
		else if(cn_val > 288600) {	//   
		  cn_a = 7;
		  cn_b = (299000 - cn_val)/108;
		}
		else if(cn_val > 274200) {	//   
		  cn_a = 8;
...
INT rtvISDBT_ScanFrequency(UINT nChNum) 
{
	...
	RTV_REG_MASK_SET(0x7e, 0xc0, (RD00&0x0c)<<4); //                            
	RTV_REG_MASK_SET(0x7f, 0xc0, (RD00&0x03)<<6); //                           
	RTV_REG_MASK_SET(0x80, 0xc0, (RD00&0x30)<<2); //                             
	
	RTV_REG_MASK_SET(0x6a, 0x07, 0x07); //                      
    ...
    {       
		...
		RTV_REG_MAP_SEL(RF_PAGE);
        RTV_REG_MASK_SET(0x6a, 0x07, 0x00); //                     

...
/*                                                                              
	...
	/*                           */
	#define RTV_MASTER_CHIP_SEL 		RaonTvChipIdx = 0; /*            */
	#define RTV_SLAVE_CHIP_SEL			RaonTvChipIdx = 1; /*           */
	
#else	
	#define RaonTvChipIdx				0 /*                          */
...
#define RTV_INVALID_CHIP_IDX				-11 //                               
...
#define RTV_FM_CH_STEP_FREQ_KHz		50 //       
...
/*                                                                              
	...
	#define RTV_TDMB_CIF_HEADER_SIZE    4 /*       */ 
#else            
	#define RTV_TDMB_CIF_HEADER_SIZE    16 /*       */ 
#endif   
...
typedef struct
{
	...
	UINT msc_size[RTV_MAX_NUM_MULTI_SUB_CHANNEL];  /*              */
	UINT msc_subch_id[RTV_MAX_NUM_MULTI_SUB_CHANNEL]; /*                        */	
	U8   *msc_buf_ptr[RTV_MAX_NUM_MULTI_SUB_CHANNEL]; /*                             */
} RTV_CIF_DEC_INFO;

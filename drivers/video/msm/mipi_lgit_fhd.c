...
#define INVERSION_NORMAL_REG_1 0x30   //                   
#define INVERSION_NORMAL_REG_2 0xF7   
#else
#define INVERSION_NORMAL_REG_1 0x32   //                   
#define INVERSION_NORMAL_REG_2 0xF7   
#endif
#define INVERSION_RECOVERY_REG_1 0x30   //                
#define INVERSION_RECOVERY_REG_2 0x17   //                
...
#define LCD_STATUS_ALWAYS_INVERSION_NORMAL  0x02//                                    
#define LCD_STATUS_ALWAYS_INVERSION_RECOVERY 0x03 //                                      
...
#define CHANGE_INVERSION_INTERVAL 60*60 //    

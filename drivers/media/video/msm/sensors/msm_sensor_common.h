...
/*                                                                         */
	int32_t (*sensor_special_effect) (struct msm_sensor_ctrl_t *, uint8_t);				//                          
	int32_t (*sensor_exposure_compensation) (struct msm_sensor_ctrl_t *, uint8_t);		//                             
	int8_t (*sensor_set_focus_mode_setting)(struct msm_sensor_ctrl_t *, int32_t);		//                                         
	int8_t (*sensor_start_af)(struct msm_sensor_ctrl_t *);							//                                 
	int8_t (*sensor_stop_af)(struct msm_sensor_ctrl_t *);							//                                
	int8_t (*sensor_whitebalance_setting)(struct msm_sensor_ctrl_t *, uint8_t);			//                                               
	int8_t (*sensor_set_zoom_ratio)(struct msm_sensor_ctrl_t *, int32_t);				//                                            
	int8_t (*sensor_set_manual_focus_length)(struct msm_sensor_ctrl_t *, int32_t);		//                                  
	int8_t (*sensor_set_led_flash_mode)(struct msm_sensor_ctrl_t *, int32_t);			//                                               
	int8_t (*sensor_set_antibanding_ce1702)(struct msm_sensor_ctrl_t *, int32_t);		//                                        
	int8_t (*sensor_set_af_window)(struct msm_sensor_ctrl_t *, int16_t *);				//                                      
	int8_t (*sensor_set_ae_window)(struct msm_sensor_ctrl_t *, int16_t *);				//                                      
	int (*sensor_object_tracking) (struct msm_sensor_ctrl_t *, struct rec_t*);			//                                                                             
	int8_t (*sensor_set_aec_awb_lock)(struct msm_sensor_ctrl_t *, int32_t);				//                                         
	...
	int8_t (*sensor_set_iso)(struct msm_sensor_ctrl_t *, int32_t);						//                                           
	int8_t (*sensor_set_manual_scene_mode)(struct msm_sensor_ctrl_t *, int32_t);		//                                                   
	int (*sensor_set_gyro_data) (struct msm_sensor_ctrl_t *, uint8_t *);				//                                              
	int8_t (*sensor_set_wdr)(struct msm_sensor_ctrl_t *, int32_t);						//                                       
	...
	int8_t (*sensor_set_asd_enable)(struct msm_sensor_ctrl_t *, int32_t);					//                                       
